...
# for DAYc  in `head -10 /lustre0/scratch/ga254/dem_bj/AE_C6_MYD04_L2/day_list.txt`; do qsub -v DAYc=$DAYc,WIND=15 /lustre0/scratch/ga254/scripts_bj/environmental-layers/terrain/procedures/dem_variables/AE_C51_MOD04_L2_MYD04_L2/sc2_window_median_C51_w15.sh; done
