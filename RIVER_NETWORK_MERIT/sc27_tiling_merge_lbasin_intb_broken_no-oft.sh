...
#SBATCH -n 1 -c 3 -N 1
#SBATCH -t 10:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc27_tiling_merge_lbasin_intb_broken_no-oft.sh.%A_%a.out
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc27_tiling_merge_lbasin_intb_broken_no-oft.sh.%A_%a.err
...
export GRASS=/tmp
export RAM=/dev/shm
# export RAMT=/gpfs/scratch60/fas/sbsc/ga254/grace0/dataproces/RIVER_NETWORK_MERIT/tmp
export RAMT=/dev/shm
