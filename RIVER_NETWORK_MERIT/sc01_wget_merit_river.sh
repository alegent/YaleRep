...
wget --user=flowdirection  --password=testdirection   http://hydro.iis.u-tokyo.ac.jp/~yamadai/GlobalDir/distribute/v0.3/$file 
...
wget --user=flowupgection  --password=testupgection   http://hydro.iis.u-tokyo.ac.jp/~yamadai/GlobalUpg/distribute/v0.3/$file 
tar zxf $file ;   rm  -f  $file 
