...
#SBATCH -n 1 -c 1 -N 1
#SBATCH -t 10:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc22_IDunify_MacroTile1pixeloverlap.sh.%J.out 
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc22_IDunify_MacroTile1pixeloverlap.sh.%J.err
...
export DIR=/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GEO_AREA/tile_files
export RAM=/dev/shm
export INDIR=/gpfs/scratch60/fas/sbsc/ga254/grace0/dataproces/RIVER_NETWORK_MERIT/lbasin_tiles_1pixel_reclass 
...
MAX=$(pkstat -max -i /gpfs/scratch60/fas/sbsc/ga254/grace0/dataproces/RIVER_NETWORK_MERIT/lbasin_tiles_1pixel_reclass/lbasin_h08v03.tif  | awk ' { print $2  }' )
