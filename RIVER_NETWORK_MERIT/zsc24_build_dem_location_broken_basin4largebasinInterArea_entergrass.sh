...
#SBATCH -n 1 -c 1 -N 1
#SBATCH -t 168:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc24_build_dem_location_broken_basin4largebasinInterArea_entergrass.sh.%A_%a.out 
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc24_build_dem_location_broken_basin4largebasinInterArea_entergrass.sh.%A_%a.err
