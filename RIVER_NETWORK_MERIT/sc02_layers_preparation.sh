...
#SBATCH -e  /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc02_layers_preparation.sh%A_%a.err
#SBATCH -o  /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc02_layers_preparation.sh%A_%a.out
...
# 1150 files 
file=$(ls  /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dir/*_dir.tif | tail -n  $SLURM_ARRAY_TASK_ID | head -1 )
...
pkgetmask  -min 254 -max 256  -ot Byte  -co COMPRESS=DEFLATE -co ZLEVEL=9 -i $file -o /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dep/${filename}_dep.tif
gdal_edit.py -a_nodata 0 /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dep/${filename}_dep.tif
fi 

gdalbuildvrt -overwrite -srcnodata 0 -vrtnodata 0 /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dep/all_tif.vrt   /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dep/*.tif 
rm  -f /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dep/all_tif_shp.* 
gdaltindex  /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dep/all_tif_shp.shp   /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dep/*.tif 

# for cheching 
# ls /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/dep/*.tif | xargs -n 1 -P 12  bash -c $' DEP=$(pkstat -max  -i  $1  | awk \'{  print $2  }\' ) ; if [ $DEP -eq 1 ] ; then echo  $1 ; fi   ' _ 


# extract mask land 0 1  
file=$(ls  /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK_MERIT/elv/*_elv.tif | tail -n  $SLURM_ARRAY_TASK_ID | head -1 )
