...
#SBATCH -n 1 -c 12 -N 1  
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc30_bin_LSTextract1.sh.%J.out
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc30_bin_LSTextract1.sh.%J.err
