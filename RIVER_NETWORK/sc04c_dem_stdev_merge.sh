...
#SBATCH -n 1 -c 1 -N 1  
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc01c_dem_stdev_merge.%J.out
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc01c_dem_stdev_merge.%J.err
...
gdal_edit.py  -a_srs EPSG:4326  -a_ullr  $( getCorners4Gtranslate /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK/dem/be75_grd_LandEnlarge.tif  )  $OUTDIR/stdev$RADIUS/be75_grd_LandEnlarge_stdev$RADIUS.tif

pksetmask -co COMPRESS=DEFLATE -co ZLEVEL=9   -ot UInt32 -m /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GSHHG/GSHHS_land_mask250m_enlarge_clumpMSK.tif  -msknodata 0  -nodata 65535  -i    $OUTDIR/stdev$RADIUS/be75_grd_LandEnlarge_stdev$RADIUS.tif -o  $DIR/stdev$RADIUS/be75_grd_LandEnlarge_stdev$RADIUS.tif 
