...
#SBATCH -n 4 -c 1 -N 1
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc04_build_dem_location_GLOBE_imp_stdev.sh.%J.out
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc04_build_dem_location_GLOBE_imp_stdev.sh.%J.err
...
# sbatch  -J sc04_build_dem_location_GLOBE_imp_stdev.sh  /gpfs/home/fas/sbsc/ga254/scripts/RIVER_NETWORK/sc04_build_dem_location_GLOBE_imp_stdev.sh
...
RADIUS=$1
r.in.gdal in=/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK/dem_stdev/stdev${RADIUS}/be75_grd_LandEnlarge_stdev${RADIUS}.tif  out=be75_grd_LandEnlarge_std${RADIUS}_GLOBE_pk   --overwrite
