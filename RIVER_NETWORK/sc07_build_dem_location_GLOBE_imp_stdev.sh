...
#SBATCH -n 4 -c 1 -N 1
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc07_build_dem_location_GLOBE_imp_stdev.sh.%J.out 
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc07_build_dem_location_GLOBE_imp_stdev.sh.%J.err
