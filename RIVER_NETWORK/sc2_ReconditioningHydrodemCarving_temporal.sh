# qsub /home/fas/sbsc/ga254/scripts/RIVER_NETWORK/sc2_ReconditioningHydrodemCarving_temporal.sh
...
rm -r   /lustre/scratch/client/fas/sbsc/ga254/dataproces/RIVER_NETWORK/grassdb/loc_river_tmp



source /lustre/home/client/fas/sbsc/ga254/scripts/general/create_location_grass7.0.2.sh  /lustre/scratch/client/fas/sbsc/ga254/dataproces/RIVER_NETWORK/grassdb loc_river_tmp /lustre/scratch/client/fas/sbsc/ga254/dataproces/RIVER_NETWORK/dem/be75_grd_LandEnlarge.tif 
...
#  0 is set as nodata in the geotif so will be report as null 
r.mask raster=land_mask250m_enlarge

echo start r.mapcalc

r.mapcalc "be75_grd_LandEnlarge_cond_carv  =  be75_grd_LandEnlarge  - ( GIW_water_250m_bordermsk  * 22 )"  --overwrite
