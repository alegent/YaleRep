...
if [ $N = "200" ] ; then 
r.in.gdal in=/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/RIVER_NETWORK/dem_stdev/stdev${RADIUS}/be75_grd_LandEnlarge_stdev${RADIUS}.tif out=fin_be75_grd_LandEnlarge_std${RADIUS}_GLOBE_pk --overwrite  memory=2000
