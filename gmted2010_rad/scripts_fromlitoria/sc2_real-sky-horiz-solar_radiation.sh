...
# ls  /mnt/data2/scratch/GMTED2010/tiles/mn75_grd_tif/{1_1,1_2,2_1,2_2,1_0,2_0}.tif  | xargs -n 1  -P 10  bash /mnt/data2/scratch/GMTED2010/scripts/sc2_real-sky-horiz-solar_radiation.sh
...
r.sun -s  elevin=$file slope=0  linkein=${LT}_${filename}_coef   albedo=${filename}_albWS_day${day}_coef    coefbh=cloud${MONTH}_${filename}_coef     day=$day step=1 \
glob_rad=glob_HradC_day$day"_"$filename \
diff_rad=diff_HradC_day$day"_"$filename \
beam_rad=beam_HradC_day$day"_"$filename \
refl_rad=refl_HradC_day$day"_"$filename --overwrite

g.remove rast=${filename}_albWS_day${day}_coef

r.out.gdal -c type=Float32  nodata=-1  createopt="COMPRESS=LZW,ZLEVEL=9"  input=glob_HradC_day$day"_"$filename    output=$INDIRD/glob_rad/${day}/glob_HradC_day$day"_"$file
r.out.gdal -c type=Float32  nodata=-1  createopt="COMPRESS=LZW,ZLEVEL=9"  input=diff_HradC_day$day"_"$filename    output=$INDIRD/diff_rad/${day}/diff_HradC_day$day"_"$file
r.out.gdal -c type=Float32  nodata=-1  createopt="COMPRESS=LZW,ZLEVEL=9"  input=beam_HradC_day$day"_"$filename    output=$INDIRD/beam_rad/${day}/beam_HradC_day$day"_"$file
r.out.gdal -c type=Float32  nodata=-1  createopt="COMPRESS=LZW,ZLEVEL=9"  input=refl_HradC_day$day"_"$filename    output=$INDIRD/refl_rad/${day}/refl_HradC_day$day"_"$file
...
gdal_translate  -a_ullr   $(getCorners4Gtranslate $file)  $INDIRD/glob_rad/${day}/glob_HradC_day$day"_"$file $INDIRD/glob_rad/${day}/glob_HradC_day$day"_"$file"_tmp"
gdal_translate  -a_ullr   $(getCorners4Gtranslate $file)  $INDIRD/diff_rad/${day}/diff_HradC_day$day"_"$file $INDIRD/diff_rad/${day}/diff_HradC_day$day"_"$file"_tmp"
gdal_translate  -a_ullr   $(getCorners4Gtranslate $file)  $INDIRD/beam_rad/${day}/beam_HradC_day$day"_"$file $INDIRD/beam_rad/${day}/beam_HradC_day$day"_"$file"_tmp"
gdal_translate  -a_ullr   $(getCorners4Gtranslate $file)  $INDIRD/refl_rad/${day}/refl_HradC_day$day"_"$file $INDIRD/refl_rad/${day}/refl_HradC_day$day"_"$file"_tmp"

mv $INDIRD/glob_rad/${day}/glob_HradC_day$day"_"$file"_tmp" $INDIRD/glob_rad/${day}/glob_HradC_day$day"_"$file 
mv $INDIRD/diff_rad/${day}/diff_HradC_day$day"_"$file"_tmp" $INDIRD/diff_rad/${day}/diff_HradC_day$day"_"$file 
mv $INDIRD/beam_rad/${day}/beam_HradC_day$day"_"$file"_tmp" $INDIRD/beam_rad/${day}/beam_HradC_day$day"_"$file 
mv $INDIRD/refl_rad/${day}/refl_HradC_day$day"_"$file"_tmp" $INDIRD/refl_rad/${day}/refl_HradC_day$day"_"$file 
