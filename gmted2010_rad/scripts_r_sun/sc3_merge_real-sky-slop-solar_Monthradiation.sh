...
# for DIR in  beam  diff  glob refl ; do bash  /mnt/data2/scratch/GMTED2010/scripts/sc3_merge_real-sky-slop-solar_Monthradiation.sh  $DIR ; done 


export DIR=$1
export INDIR=/mnt/data2/scratch/GMTED2010/grassdb/${DIR}_rad/months_gr_slope1
export OUTDIR=/mnt/data2/scratch/GMTED2010/grassdb/${DIR}_rad/months_merge_slope1
