...
export OUTDIR=months_gr_horiz1
...
r.sun -s  elevin=$file slope=0  linkein=linke${day}_${filename}_coef    albedo=albedo${day}_${filename}_coef    coefbh=cloud${day}_${filename}_coef     day=$day step=1 horizon=horiz  horizonstep=15   --overwrite  \
glob_rad=glob_HradC_day$day \
diff_rad=diff_HradC_day$day \
beam_rad=beam_HradC_day$day 
