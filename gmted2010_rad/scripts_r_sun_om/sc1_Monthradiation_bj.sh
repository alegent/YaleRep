...
# gdal_edit  -a_ullr  $(getCorners4Gtranslate $INDIRG/$tile.tif )    $OUTDIR/diff_Hrad_day_tiles/$day/diff_HradT_day$day"_"month$monthc"_"$tile.tif 
# gdal_edit  -a_ullr  $(getCorners4Gtranslate $INDIRG/$tile.fif )    $OUTDIR/beam_Hrad_day_tiles/$day/beam_HradT_day$day"_"month$monthc"_"$tile.tif
# gdal_edit  -a_ullr  $(getCorners4Gtranslate $INDIRG/$tile.tif)  $OUTDIR/refl_Hrad_day_tiles/$day/refl_HradT_day$day"_"month$monthc"_"$tile.tif
