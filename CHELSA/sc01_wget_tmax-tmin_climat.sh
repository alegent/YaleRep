...
#SBATCH -n 1 -c 12 -N 1
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc01_wget_tmax-tmin_climat.sh.%J.out 
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc01_wget_tmax-tmin_climat.sh.%J.err
...
cd /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/CHELSA/${VAR}_clim
export VAR
