...
# 	gdal_translate -a_nodata "none"  -projwin  $(getCorners4Gtranslate    $OUTDIR/GMTED/$AREA/md75_grd_tif.tif )   -co COMPRESS=LZW  -co ZLEVEL=9   $GMTED/final/aspect/${var2}_${MAT2}_GMTED2010_md_km${km}.tif  $OUTDIR/GMTED/$AREA/${var2}_${MAT2}_GMTED2010_md_km${km}.tif
#     done 
# done 
