...
# source ("/lustre/home/client/fas/sbsc/ga254/scripts/gmted2010_res_x10/sc40_profileSRTM-GMTED.R.sh") 
...
postscript("/lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_90_250m.ps" ,  paper="special" ,  horizo=F , width=4, height=11  )	

par (oma=c(1,1,1,1) , mar=c(1,4,1,1) , cex.lab=0.8 , cex=0.8 , cex.axis=0.8  , mfrow=c(10,1) )
...
system("ps2pdf  /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_90_250m.ps /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_90_250m.pdf")
system("convert -flatten -density 300  /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_90_250m.ps /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_90_250m.png")
system("ps2epsi /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_90_250m.ps /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_90_250m.eps")

postscript("/lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_1_100km.ps" ,  paper="special" ,  horizo=F , width=4, height=11  )	
...
system("ps2pdf  /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_1_100km.ps /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_1_100km.pdf")
system("convert -flatten -density 300  /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_1_100km.ps /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_1_100km.png")
system("ps2epsi /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_1_100km.ps /lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/correlation/SRTM_GMTED/figure/profile_SRTMGMTED_1_100km.eps")