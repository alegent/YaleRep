...
# for DIR in  md75_grd mi75_grd mn75_grd mx75_grd be75_grd ds75_grd sd75_grd  ; do  qsub -v DIR=$DIR  /lustre/home/client/fas/sbsc/ga254/scripts/gmted2010_res_x10/sc3_tilingLarg_gmted2010-7.5.sh  ; done

# for DIR in  be75_grd  ; do  bash   /lustre/home/client/fas/sbsc/ga254/scripts/gmted2010_res_x10/sc3_tilingLarg_gmted2010-7.5.sh   $DIR ; done
...
INDIR=/lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/tiles
cd $INDIR
...
ny=$2
DIR=$3
INDIR=/lustre/scratch/client/fas/sbsc/ga254/dataproces/GMTED2010/tiles/$DIR"_tif"
