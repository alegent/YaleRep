...
# for file in `ls /lustre0/scratch/ga254/dem_bj/GMTED2010/tiles/md75_grd_tif/?_?.tif` ; do qsub  -v file=$file  /lustre0/scratch/ga254/scripts_bj_bk/environmental-layers/terrain/procedures/dem_variables/gmted2010_res_x10/sc5b_dem_variables_bj.sh ; done 

# for file in `ls /lustre0/scratch/ga254/dem_bj/GMTED2010/tiles/md75_grd_tif/?_?.tif` ; do bash  /lustre0/scratch/ga254/scripts_bj_bk/environmental-layers/terrain/procedures/dem_variables/gmted2010_res_x10/sc5b_dem_variables_bj.sh $file   ; done 
# file=$1   
