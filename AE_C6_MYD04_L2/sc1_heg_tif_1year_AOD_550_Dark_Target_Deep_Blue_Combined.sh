...
# for YEAR in 2003 2013 2014 ; do   qsub  -v YEAR=$YEAR /lustre0/scratch/ga254/scripts_bj/environmental-layers/terrain/procedures/dem_variables/AE_C6_MYD04_L2/sc1_heg_tif_1year_Deep_Blue_Aerosol_Optical_Depth_550_Land_Best_Estimate.sh  ; done 
