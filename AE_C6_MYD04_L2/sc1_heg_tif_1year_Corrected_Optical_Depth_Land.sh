...
if [ -f $TIFDIR/Corrected_Optical_Depth_Land_year${YEAR}_day$DAY.tif ] ; then 
    echo the file  Corrected_Optical_Depth_Land_year${YEAR}_day$DAY.tif  exist
else
...
for band in Corrected_Optical_Depth_Land   ; do 
