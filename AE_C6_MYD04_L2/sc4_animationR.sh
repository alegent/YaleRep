...
path = "/lustre/scratch/client/fas/sbsc/ga254/dataproces/AE_C6_MYD04_L2/temp_smoth_10km/"
...
basename=paste("AOD_10km_day",day,sep="")
## not sure exactly what this does, but there is basename(file) too...

png(paste("/lustre/scratch/client/fas/sbsc/ga254/dataproces/AE_C6_MYD04_L2/png_smoth_10km/",basename,".png",sep=""),width=2000,height=1000)

## add width and height to specify the size of the png, otherwise it will be small (100x100, I think)
 
day001=raster(paste("/lustre/scratch/client/fas/sbsc/ga254/dataproces/AE_C6_MYD04_L2/temp_smoth_10km/AOD_10km_day",day,".tif",sep=""))
