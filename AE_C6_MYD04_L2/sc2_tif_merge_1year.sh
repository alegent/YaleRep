...
pksetmask  -m $TIFDIR/Quality_Assurance_Land_year${YEAR}_day$DAY.tif    -msknodata 17 -nodata -9999   -i  $TIFDIR/Corrected_Optical_Depth_Land_year${YEAR}_day$DAY.tif  -o  $TIFDIR/Corrected_Optical_Depth_Land_QA_year${YEAR}_day$DAY.tif  
