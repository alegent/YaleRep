...
# bash  /lustre0/scratch/ga254/scripts_bj/environmental-layers/terrain/procedures/dem_variables/AE_C6_MYD04_L2/sc1_heg_tif.sh  2004 100
...
for band in  AOD_550_Dark_Target_Deep_Blue_Combined_QA_Flag  AOD_550_Dark_Target_Deep_Blue_Combined ; do 
