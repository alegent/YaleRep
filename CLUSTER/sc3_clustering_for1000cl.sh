...
cp /lustre/scratch/client/fas/sbsc/ga254/dataproces/CLUSTER/cluster/spec_11907.xxx  /dev/shm/

oft-kmeans -um $MSKDIR/mask.tif  -ot UInt16  -oi  /dev/shm/cluster_1000.tif   $NORDIR/stack.tif <<EOF
/dev/shm/spec_11907.xxx
1000
EOF

mv   /dev/shm/cluster_1000.tif  $OUTDIR/cluster_1000.tif 
