...
export DIR=/gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/HYDROSHEDS/shp30sec
...
# gdal_rasterize   -co COMPRESS=DEFLATE -co ZLEVEL=9 -tr  0.00833333333333333 0.00833333333333333 -te $( getCorners4Gwarp  /gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NITRO/prediction/prediction_WQmean_order7.tif ) -init 0  -a_nodata 0 -burn 1 -ot Byte   $file $DIR/$filename.tif
# ' _
