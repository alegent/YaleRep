...
# for file in $(ls /lustre/scratch/client/fas/sbsc/ga254/dataproces/LST/India/indiaLST_MYD_day209_wgs84.tif  ) ; do qsub  -v file=$file /lustre/home/client/fas/sbsc/ga254/scripts/LST/sc10_gwr_grass.sh   ; done 
# for file in `ls  /lustre/scratch/client/fas/sbsc/ga254/dataproces/LST/India/indiaLST_MYD_day209_wgs84.tif ` ; do bash /lustre/home/client/fas/sbsc/ga254/scripts/LST/sc10_gwr_grass.sh  $file   ; done 
...
# /home/fas/sbsc/ga254/.grass7/addons/bin/r.gwr    mapx=india_cons_1,india_cons_2,india_cons_3,india_cons_4,india_cons_5,india_cons_6,india_cons_7,india_cons_8,india_cons_9,india_cons_10,india_cons_11,india_cons_12,india_eastness_md_GMTED2010_md,india_northness_md_GMTED2010_md,india_elevation_md_GMTED2010_md  mapy=$(basename $file .tif)  residuals=res_$(basename $file .tif) estimates=est_$(basename $file .tif) coefficients=coef output=regres_coef_$(basename $file .tif).txt  kernel=gauss  vf=1 bandwidth=5000   --overwrite  

/home/fas/sbsc/ga254/.grass7/addons/bin/r.gwr   mapx=india_eastness_md_GMTED2010_md,india_northness_md_GMTED2010_md,india_elevation_md_GMTED2010_md  mapy=$(basename $file .tif)  residuals=res_$(basename $file .tif) estimates=est_$(basename $file .tif) coefficients=coef output=regres_coef_$(basename $file .tif).txt  kernel=gauss  vf=1  --overwrite   bandwidth=141
