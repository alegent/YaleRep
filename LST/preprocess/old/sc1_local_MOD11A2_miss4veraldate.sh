...
# for DAY in $(cat /nobackup/gamatull/dataproces/LST/geo_file/list_day.txt  ) ; do qsub  -v YEAR=$YEAR  -v  DAY=$DAY /u/gamatull/scripts/LST/sc1_local_MOD11A2_miss.sh ; done 
