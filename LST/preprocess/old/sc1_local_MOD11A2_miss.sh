...
# for DAY in $(cat /nobackup/gamatull/dataproces/LST/geo_file/list_day.txt  ) ; do qsub -v DAY=$DAY /u/gamatull/scripts/LST/sc1_local_MOD11A2_miss.sh ; done 
...
echo 2001 2002 2010 2011 2012 2013  2014  | xargs -n 1 -P 3  bash -c $' 
