...
#  ~/bin/pkfilter -ct "none" -ot UInt16   -co COMPRESS=DEFLATE -co ZLEVEL=9   -d 40 -dx 40 -dy 40  -f sum -i /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NHDplus/NHDplus_H_250m_norm.tif   -o $DIR/NHDplus_H_10km_sum.tif

pkstat -hist -i $DIR/NHDplus_H_10km_sum.tif > $DIR/NHDplus_H_10km_sum.txt 


gdal_edit.py -a_nodata 0  /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NHDplus/NHDplus_H_10km_sum.tif 

rm -r /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NHDplus/grassdb/location
/gpfs/home/fas/sbsc/ga254/scripts/general/create_location_grass7.0.2-grace2.sh /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NHDplus/grassdb location /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NHDplus/NHDplus_H_10km_sum.tif 
