...
gdalbuildvrt -overwrite  -te $( getCorners4Gwarp /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NHDplus/tif_merge/NHDplus_90m.tif )   $DIR/tif_streambasin/${VAR}.vrt  $MERIT/${VAR}_tiles_final20d/{${VAR}_h04v02.tif,${VAR}_h06v02.tif,${VAR}_h08v02.tif,${VAR}_h10v02.tif,${VAR}_h04v04.tif,${VAR}_h06v04.tif,${VAR}_h08v04.tif,${VAR}_h10v04.tif} 
