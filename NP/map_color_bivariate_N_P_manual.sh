...
# print(paste0(dirIn,figmean))
# print(paste0(dirIn,figstd))
# print(figShp)
...
# countrybords<-shapefile(figShp)
# countrybords_reproj<- spTransform(countrybords, crs(tonscatch_crop))
# map(countrybords, add=T, col="black", lwd=0.5)
dev.off()
