...
export ZIP=/gpfs/loomis/scratch60/fas/sbsc/ga254/grace0/dataproces/3DEP/zip
export TIF=/gpfs/loomis/scratch60/fas/sbsc/ga254/grace0/dataproces/3DEP/tif

cd $ZIP

cat /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/3DEP/list_zip.txt | xargs -n 1 -P 10  bash -c $'
file=$1
