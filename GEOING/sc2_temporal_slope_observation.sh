...
gdal_translate -ot Float32  -co COMPRESS=DEFLATE  -co ZLEVEL=9 $DIR/reg_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.reg.nc  $DIR/reg_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.reg_tmp.tif
pksetmask -co COMPRESS=DEFLATE -co ZLEVEL=9 -m  $DIR/reg_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.reg_tmp.tif -msknodata 10000 -p ">" -nodata -9999 -i   $DIR/reg_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.reg_tmp.tif -o  $DIR/reg_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.reg.tif
rm -f  $DIR/reg_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.reg_tmp.tif
...
pkfilter -of GTiff -dx 2 -dy 2  -f mean -d 2  -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND -nodata -9999 -ot Float32  -i  $DIR/reg_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.reg.tif -o $DIR/reg_CRU/cru_ts3.23.$YYYY.pre.dat_1.0deg.reg.tif 
pkfilter -of GTiff -dx 2 -dy 2  -f mean -d 2  -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND -nodata -9999 -ot Float32  -i  $DIR/reg_CRU/cru_ts3.23.$YYYY.tmp.dat_0.5deg.reg.tif -o $DIR/reg_CRU/cru_ts3.23.$YYYY.tmp.dat_1.0deg.reg.tif
...
gdal_translate -ot Float32  -co COMPRESS=DEFLATE  -co ZLEVEL=9 $DIR/mean_CRU/cru_ts3.23.$YYYY.tmp.dat_0.5deg.mean.nc  $DIR/mean_CRU/cru_ts3.23.$YYYY.tmp.dat_0.5deg.mean.tif 
gdal_translate -ot Float32  -co COMPRESS=DEFLATE  -co ZLEVEL=9  $DIR/mean_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.mean.nc  $DIR/mean_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.mean_tmp.tif
pksetmask -co COMPRESS=DEFLATE -co ZLEVEL=9 -m $DIR/mean_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.mean_tmp.tif -msknodata 10000 -p ">" -nodata -9999 -i  $DIR/mean_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.mean_tmp.tif -o $DIR/mean_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.mean.tif
rm -f   $DIR/mean_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.mean_tmp.tif

pkfilter -of GTiff -dx 2 -dy 2  -f mean -d 2  -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND  -ot Float32  -nodata -9999 -i  $DIR/mean_CRU/cru_ts3.23.$YYYY.pre.dat_0.5deg.mean.tif -o $DIR/mean_CRU/cru_ts3.23.$YYYY.pre.dat_1.0deg.mean.tif
pkfilter -of GTiff -dx 2 -dy 2  -f mean -d 2  -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND  -ot Float32  -nodata -9999 -i  $DIR/mean_CRU/cru_ts3.23.$YYYY.tmp.dat_0.5deg.mean.tif -o $DIR/mean_CRU/cru_ts3.23.$YYYY.tmp.dat_1.0deg.mean.tif
