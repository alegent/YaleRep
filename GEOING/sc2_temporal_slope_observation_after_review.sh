...
write.table(mean, paste0(DIR,"/reg_HadISST10/HadISST_sst.",YYYY,".tmp.dat_1.0deg.regAREA",YSTART,".",YEND,"wightedmean.txt" ), sep = " " , col.names = FALSE , quote = FALSE , row.names=FALSE  )
