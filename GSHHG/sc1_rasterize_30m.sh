...
# for LIST in tiles16_listF1.txt ; do bash    /home/fas/sbsc/ga254/scripts/GSHHG/sc1_rasterize_30m.sh $LIST  ; done 

# for LIST in tiles16_listF*.txt ; do qsub -v LIST=$LIST  /home/fas/sbsc/ga254/scripts/GSHHG/sc1_rasterize_30m.sh  ; done 
...
echo rasterize 30 meter $tile   

rm -f  ${TIFOUT}_30m/${tile}_30m.tif

# -at any Enables the ALL_TOUCHED rasterization 
gdal_rasterize   -at  -tr 0.00026041666666666666666  0.00026041666666666666666 -burn  1  -te  $xmin $ymin $xmax $ymax -co COMPRESS=DEFLATE -co ZLEVEL=9  -ot Byte -l $tile  $RAM/$tile.shp    ${TIFOUT}_30m/${tile}_30m.tif
