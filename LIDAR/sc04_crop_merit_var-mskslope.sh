...
#SBATCH -n 1 -c 8 -N 1  
#SBATCH -t 3:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc04_crop_merit_var.sh.%J.out
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc04_crop_merit_var.sh.%J.err
...
export LIDAR=/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/LIDAR
...
# ls /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/LIDAR/*/dsm*.tiff | grep -v aspect  | xargs -n 1 -P 8 bash -c $' 
# file=$1
...
ls /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/LIDAR/aspect/dsm*e_{cos,sin,Nw,Ew}.tiff | xargs -n 1 -P 8 bash -c $' 
file=$1
filename=$(basename $file)
