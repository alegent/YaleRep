...
ls /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/LIDAR/*/dsm*.tif | grep -v aspect  | xargs -n 1 -P 8 bash -c $' 
file=$1
...
ls /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/LIDAR/aspect/dsm*{cos,sin,Nw,Ew}.tif | xargs -n 1 -P 8 bash -c $' 
file=$1
filename=$(basename $file)
