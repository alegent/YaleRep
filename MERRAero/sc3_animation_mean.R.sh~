...
path = "/lustre0/scratch/ga254/dem_bj/MERRAero/tif_mean_w15_day365/"
...
png(paste("/lustre0/scratch/ga254/dem_bj/MERRAero/png_mean_w15_day365/",basename , ".png" ,sep=""),width=2000,height=1000)
## add width and height to specify the size of the png, otherwise it will be small (100x100, I think)
 
day001=raster(paste("/lustre0/scratch/ga254/dem_bj/MERRAero/tif_mean_w15_day365/",file,sep=""))
