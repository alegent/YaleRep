...
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc20_flow1k_vs_grwl_grwlarea.sh.%A.%a.out  
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc20_flow1k_vs_grwl_grwlarea.sh.%A.%a.err
...
file=$( ls /gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GRWL/GRWL_mask_V01.01_wgs84_merge/*.tif |  head  -n  $SLURM_ARRAY_TASK_ID     | tail  -1 ) 
tile=$(basename $file )

# tile=h10v03.tif

NITRO=/gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NITRO
 AREA=/gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NITRO/GRWL/area 
AREAK=/gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/NITRO/GRWL/area_1km
 ...
 GRWL=/gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GRWL/GRWL_mask_V01.01_wgs84_merge
