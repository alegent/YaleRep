...
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc12_continue90M_to10KMforValidation.sh.%J.out
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc12_continue90M_to10KMforValidation.sh.%J.err
...
gdalbuildvrt  -te  $(getCorners4Gwarp    /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/MERIT/input_tif/all_tif.vrt )  -overwrite  $SCRATCH/$TOPO/$MATH/tiles_km$KM.vrt   $SCRATCH/$TOPO/$MATH/tiles_km$KM/*_E7.tif
