...
# for TOPO in altitude stdev aspect dx dxx dxy dy dyy pcurv roughness slope tcurv tpi tri vrm tci spi convergence intensity exposition range variance elongation azimuth extend width ; do for MATH in min max mean median stdev ; do for KM in 1 5 10; do sbatch --export=TOPO=$TOPO,KM=$KM,MATH=$MATH /gpfs/home/fas/sbsc/ga254/scripts/MERIT/sc09_equi_warp_wgs84_continue_1_100KM.sh ; done ; done ; done 
