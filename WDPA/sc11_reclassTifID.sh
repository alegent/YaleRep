...
cat tif_out_list*.tar.csv  > gridID_polyID.csv
...
awk -F ,    '$1 != prev{printf "%s%s",ors,$1; ors=ORS; ofs=" "} {printf "%s%s",ofs,$2; ofs=""; prev=$1} END{print ""}' gridID_polyID_rowgroup_s.txt 
