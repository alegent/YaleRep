...
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc03_gdalwarp_mask_wgs84_merge.sh.%A.%a.out  
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc03_gdalwarp_mask_wgs84_merge.sh.%A.%a.err
...
# cd /project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GRWL/GRWL_mask_V01.01
# for file in *.tif ; do echo ${file:0:6} ; done  | sort | uniq > tile_list.txt 

tile=$( head  -n  $SLURM_ARRAY_TASK_ID  /gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GRWL/GRWL_mask_V01.01_wgs84/tile_list.txt  | tail  -1 ) 

INDIR=/gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GRWL/GRWL_mask_V01.01_wgs84
OUTDIR=/gpfs/loomis/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GRWL/GRWL_mask_V01.01_wgs84_merge
RAM=/dev/shm
