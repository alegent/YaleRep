...
path = "/home/maoningt/LEDAPS_2000/NDVI_3/"
#f = "p047r029_ndvi"
...
# export arrays
        ...
        for m in metric:
            outFile = driver.Create('/home/maoningt/LEDAPS_2000/NDVI/TextMetric/' + filename[:-8] + '_' + m + '.tif', NX, NY, 1, gdal.GDT_Float32, ['COMPRESS=LZW'])
