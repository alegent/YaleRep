...
t = time.time()
g = gdal.Open('/home/maoningt/LC/Data/glc2k_CEA.tif')
b = g.GetRasterBand(1)
a = b.ReadAsArray()
...
output = driver.Create("/home/maoningt/LC/Output/glc2k_reclass_CEA.tif", a.shape[1], a.shape[0], 1, gdal.GDT_Byte, 'COMPRESS=LZW')
