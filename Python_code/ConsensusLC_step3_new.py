...
#    output = driver.Create('D:\\Work\\Consensus\\consensus_data\\Oregon_1km_class_%s.tif' % lc, con1km[lc].shape[1], con1km[lc].shape[0], 1, gdal.GDT_Byte)
    output = driver.Create('/home/maoningt/LC/Output/con_1km_no_DISCover_class_%s.tif' % lc, con1km[lc].shape[1], con1km[lc].shape[0], 1, gdal.GDT_Byte, ['COMPRESS=LZW'])
