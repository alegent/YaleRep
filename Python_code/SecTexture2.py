...
metric = ['ASM']
MaxMin = [10000.0, 0.0]  # maximum and minimum values for rescaling images

#path = "D:\\Work\\Texture\\GLS_SR_2000\\NDVI\\masked_NDVI\\"
path = "/home/maoningt/textureMODIS/MaxEVI_5y/"
#f = "p047r029_ndvi"
...
# export arrays
        ...
        for m in metric:
            outFile = driver.Create('/home/maoningt/textureMODIS/MaxEVI_5y/texture/' + filename + '_' + m + '.tif', NX, NY, 1, gdal.GDT_Float32, ['COMPRESS=LZW'])
