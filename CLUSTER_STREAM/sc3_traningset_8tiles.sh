...
gdal_translate -srcwin  $xoff $yoff $xsize $ysize  -of XYZ   $MASK/mask.tif  $MASK/mask_x${1}_y${2}z.txt 
echo cleaning the  $MSK/mask_x${1}_y${2}.txt 

awk  \'{ if ($3==1) print $1, $2 }\'   $MASK/mask_x${1}_y${2}z.txt       >  $RAM/training_x${1}_y${2}.txt 

cp  $RAM/training_x${1}_y${2}.txt      $MASK/training_x${1}_y${2}.txt
...
if [ ! -f $RAM/training_x${1}_y${2}.txt  ] ; then echo copy the file ; cp -rf  $MASK/training_x${1}_y${2}.txt $RAM ; fi 
